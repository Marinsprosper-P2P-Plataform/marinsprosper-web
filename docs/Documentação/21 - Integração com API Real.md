...
Todos os itens de código do bucket "Fundação" do Kanban já existem — só resta a pendência de coordenação com o time de backend (`CORS_ORIGINS`, ver §0).
